                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 16, marginBottom: 24 }}>
                    ...
                    <div style={{ ...cardStyle, padding: 20 }}>
                      <div style={{ display: 'flex', gap: 32, marginBottom: 20 }}>
                        <button onClick={() => setActiveChartTab('sales')} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', border: 'none', background: 'none', borderBottom: activeChartTab === 'sales' ? '2px solid #0EA5E9' : '2px solid transparent', fontWeight: 500, fontSize: 14, cursor: 'pointer', color: activeChartTab === 'sales' ? '#111827' : '#6B7280' }}>
                          <span style={{ width: 16, height: 16, border: `2px solid ${activeChartTab === 'sales' ? '#0EA5E9' : '#D1D5DB'}`, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>{activeChartTab === 'sales' && <span style={{ width: 8, height: 8, background: '#0EA5E9', borderRadius: '50%' }} />}</span>
                          Ventes mensuelles estimées
                        </button>
                        <button onClick={() => setActiveChartTab('traffic')} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 0', border: 'none', background: 'none', borderBottom: activeChartTab === 'traffic' ? '2px solid #0EA5E9' : '2px solid transparent', fontWeight: 500, fontSize: 14, cursor: 'pointer', color: activeChartTab === 'traffic' ? '#111827' : '#6B7280' }}>
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={activeChartTab === 'traffic' ? '#0EA5E9' : '#9CA3AF'} strokeWidth="2"><polyline points="22,12 18,12 15,21 9,3 6,12 2,12" /></svg>
                          Trafic estimé
                        </button>
                      </div>
