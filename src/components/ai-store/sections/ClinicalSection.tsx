    ...
    <TooltipProvider>
      <div>
        ...
        <div className="d-flex justify-content-between align-items-center mb-3">
          <p className="mb-0 fs-lg fw-600">Section Statistiques</p>
        ...
        <AIInputField
          ...
          isSuccess={successField === 'persuasiveContent.paragraph'}
          isError={errorField === 'persuasiveContent.paragraph'}
        ...
        {[0, 1, 2, 3].map((index) => {
          ...
          const percentageField = `clinicalResults[${index}][percentage]`;
          const descriptionField = `clinicalResults[${index}][description]`;
          
          return (
            <div key={index} className="mb-4">
              <p className="mb-1 fs-small fw-500 text-muted">Résultat Statistique {index + 1}</p>
              
              {/* Percentage - NO REGENERATE BUTTON for numbers */}
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <div className="position-relative input-with-regenerate">
                  ...
                  />
                  <RegenerateButton
                    onClick={() => regenerateField(descriptionField, result.description || '')}
                    disabled={!!regeneratingField}
